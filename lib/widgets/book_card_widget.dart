                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        backgroundColor: isActual ? const Color(0xFF9999ff) : const Color(0xFFccccff),
                        child: Text(
                          widget.book.grade.toString(),
                          style: TextStyle(
                              color: isActual ? const Color(0xFFffffff) : const Color(0xFF9999ff),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Text(
                            '${widget.book.seriesSeq} - ${widget.book.seriesName}'),
                      ],
                    ),
                  ),
