...
class SwipeDetector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    DragUpdateDetails updateVerticalDragDetails = DragUpdateDetails(globalPosition:startVerticalDragDetails.globalPosition);

    //Horizontal drag details
    DragStartDetails startHorizontalDragDetails = DragStartDetails();;
    DragUpdateDetails updateHorizontalDragDetails = DragUpdateDetails(globalPosition: startHorizontalDragDetails.globalPosition);
